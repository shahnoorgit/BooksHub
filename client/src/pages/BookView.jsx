...
const BookView = () => {
  ...
  console.log(Sbook);
  return (
    <section className=" flex justify-center max-sm:flex-col max-sm:items-center max-sm:p-0 min-h-screen w-screen bg-gray-400 p-10">
      ...
      <div className="flex relative max-sm:p-2 flex-col gap-5 w-1/2 max-sm:w-full h-[40%]">
        <h1 className=" text-2xl font-bold  max-sm:-mb-5 max-sm:text-sm text-gray-900">
          {Sbook.title}
        </h1>
